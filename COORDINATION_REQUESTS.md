...
| 2026-05-09 | Integrations + Auth | Release | Repair Hosoonline split-permission enforcement and verify live grants for `external_checkups.create` and `external_checkups.upload`. | IN PROGRESS |
