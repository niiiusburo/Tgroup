...
| 2026-07-28 | Security/Backend | Employees + Customers + QA | Align all employee and Partner mutation receipts on password-field omission and verify missing employee PUT rollback before shared-table side effects. | RESOLVED |
