...
| 2026-07-28 | Payments/Data | Services Catalog + QA | Align payment creation and sale-order amount edits on the same residual row-lock order; cover invoice/dotkham contention with a PostgreSQL two-connection matrix. | RESOLVED |
