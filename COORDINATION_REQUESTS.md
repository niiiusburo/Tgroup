...
| 2026-07-28 | Integrations + Infra | QA/Verification | Verify tracked nginx `/api` 300s timeouts and DB-gated `/api/health` semantics with a shared bounded optional face probe. Live VPS nginx changes remain out of scope. | IN PROGRESS |
