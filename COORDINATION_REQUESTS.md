...
| 2026-07-28 | Integrations + Customers | QA/Verification | Validate AUD-004 Face ID investor pre-ranking scope, case-insensitive UUID membership, and role-level register/re-register denial through the focused route/provider tests and outer no-mistakes gates. | IN PROGRESS |
