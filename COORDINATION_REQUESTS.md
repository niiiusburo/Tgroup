...
| 2026-09-20 | Frontend + Backend | Appointments + Reports | Enforce a 3-month Vietnam lookback on calendar views and date-scoped reports/exports (`LOOKBACK_EXCEEDED`). | RESOLVED |
