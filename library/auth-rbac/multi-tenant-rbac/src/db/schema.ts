import {pgTable, uniqueIndex, primaryKey, uuid, text, timestamp, varchar, PrimaryKey} from 'drizzle-orm/pg-core'
...
export const roles = pgTable('roles', {
    ...
    return {
        cpk: primaryKey(roles.name, users.applicationId),
...
export const usersToRoles = pgTable("usersToRoles", {
    ...
    return {
        cpk: primaryKey(usersToRoles.applicationId,
            usersToRoles.roleId, 
            usersToRoles.userId,
            ),
    }
