...
| v1.0.11 | 2026-07-28 | `/api/HrPayslips*` reads require `employees.view`; investors (not seeded that permission) are denied payroll PII (AUD-012). |
...
#### GET /api/HrPayslips, /Runs, /Structures, /:id
