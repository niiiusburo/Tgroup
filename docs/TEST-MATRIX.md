...
| `api/src/routes/faceRecognition.js`, `website/src/components/shared/GlobalFaceIdButton.tsx`, `website/src/hooks/useFaceRecognition.ts`, `website/src/lib/api/partners.ts` | `api/tests/faceRecognition.test.js`, `website/src/components/shared/GlobalFaceIdButton.test.tsx`, `website/src/hooks/__tests__/useFaceRecognition.test.ts`, `website/src/lib/api/__tests__/faceRecognition.test.ts` | Face registration, re-registration, recognition, provider routing, and staff-visible Face ID version metadata. |
...
| `api/src/routes/faceRecognition.js`, `website/src/components/shared/GlobalFaceIdButton.tsx`, `website/src/hooks/useFaceRecognition.ts`, `website/src/lib/api/partners.ts` | `api/tests/faceRecognition.test.js`, `website/src/components/shared/GlobalFaceIdButton.test.tsx`, `website/src/hooks/__tests__/useFaceRecognition.test.ts`, `website/src/lib/api/__tests__/faceRecognition.test.ts` | Face register/re-register/recognize API contract in local and CompreFace modes, staff-visible recognition version metadata, plus hidden diagnostics recording without leaking private diagnostics in the staff response. |
...
# Validate: staff header shows the current NK2 Face ID version badge and recognition responses carry recognitionVersion
