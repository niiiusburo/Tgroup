...
| `website/src/hooks/useCalendarData.ts`, `CalendarDateNavigator.tsx`, `ReportsFilters.tsx` | `website/src/lib/__tests__/lookbackWindow.test.ts`, `api/src/lib/__tests__/dateUtils.lookback.test.js`, `api/src/routes/reports/__tests__/lookbackWindow.test.js`, `api/src/routes/appointments/__tests__/readHandlers.test.js` | INV-026. Calendar navigation and report/export date windows cannot look back more than 3 months. |
