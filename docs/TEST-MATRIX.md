...
| `api/src/routes/faceRecognition.js` | `api/tests/faceRecognition.test.js`, `api/tests/faceRecognitionInvestorScope.test.js` | Face registration, re-registration, recognition, provider routing, and investor allowlist IDOR (INV-021). |
...
| `api/src/routes/faceRecognition.js` | `api/tests/faceRecognition.test.js`, `api/tests/faceRecognitionInvestorScope.test.js` | Face register/re-register/recognize API contract in local and CompreFace modes; investor fail-closed allowlist on match/candidates/status. |
