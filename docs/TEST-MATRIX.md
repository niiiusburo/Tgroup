...
| `api/src/routes/externalCheckups.js`, `api/src/services/hosoonlineClient.js` | `api/tests/externalCheckupsInvestorScope.test.js`, `api/src/routes/__tests__/externalCheckups.test.js` | AUD-005 / INV-021. Investor IDOR on customer-code list, image-by-name proxy, patient create, and health-checkup upload; staff unaffected. |
