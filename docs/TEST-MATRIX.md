...
| Investor appointment scoping in `api/src/routes/appointments/*` and report appointment endpoints | `api/tests/investorIdorScoping.test.js`, `api/tests/investorScopeRoutePermissions.test.js` | Investor employees may view/create/edit only allowlisted customer appointments through the staff-shell permission set. |
...
| Investor payment read/write filters in `api/src/routes/payments*.js`, `api/src/routes/accountPayments.js`, `api/src/routes/receipts.js`, `api/src/routes/monthlyPlans.js` | `api/tests/investorIdorScoping.test.js`, `api/tests/investorScopeRoutePermissions.test.js`, `api/src/routes/reports/__tests__/cashFlow.test.js` | Investors may use payment staff-shell controls only against allowlisted customer payment context. |
