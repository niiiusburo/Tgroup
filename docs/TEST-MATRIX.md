...
| If you change... | Run these tests... | Why |
|---|---|---|
| `api/src/routes/employees/mutations.js` | `api/tests/employeeMutationsPasswordHash.test.js` | POST/PUT must never return `password_hash`/`password` while still bcrypt-hashing password writes (AUD-011). |
