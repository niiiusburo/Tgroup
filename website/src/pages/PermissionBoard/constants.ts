...
export const MODULES = [
  ...
  { name: 'Customers', actions: ['View', 'View All', 'Add', 'Edit', 'Delete', 'Hard Delete', 'Source Correct'] },
  { name: 'Appointments', actions: ['View', 'Add', 'Edit'] },
  { name: 'Services', actions: ['View', 'Add', 'Edit', 'Source Correct'] },
...
export const PERMISSION_DESCRIPTIONS: Record<string, string> = {
  ...
  'customers.source_correct': 'descriptions.customers.source_correct',
