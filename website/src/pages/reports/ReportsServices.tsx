 ...
 * @crossref:used-in[routed page (/reports/services): website/src/App.tsx (lazy, re-exported via website/src/pages/Reports.tsx); filters arrive via Outlet context from Reports shell]
 * @crossref:uses[website/src/hooks/useReportData.ts ('/Reports/services/breakdown' — backend api/src/routes/reports/servicesBreakdown.js), website/src/components/reports/ (KPICard, BarChart, ReportsFilters, ReportError), website/src/lib/formatting.ts (formatVND), product-map/domains/reports-analytics.yaml]
 */
