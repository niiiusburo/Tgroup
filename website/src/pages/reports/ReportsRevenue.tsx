...
export function ReportsRevenue() {
  ...
  return (
    <div className="space-y-5">
      ...
      <ExportPreviewModal
        isOpen={activeExport.previewOpen}
        onClose={activeExport.closePreview}
        onDownload={activeExport.handleDownload}
        preview={activeExport.previewData}
        loading={activeExport.loading}
