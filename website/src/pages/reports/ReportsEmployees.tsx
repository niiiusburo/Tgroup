 ...
 * @crossref:used-in[routed page (/reports/employees): website/src/App.tsx (lazy, re-exported via website/src/pages/Reports.tsx); filters arrive via Outlet context from Reports shell]
 * @crossref:uses[website/src/hooks/useReportData.ts ('/Reports/employees/overview' — backend api/src/routes/reports/employeesOverview.js), website/src/components/reports/ (KPICard, BarChart, DonutChart, ReportsFilters, ReportError), product-map/domains/reports-analytics.yaml]
 */
