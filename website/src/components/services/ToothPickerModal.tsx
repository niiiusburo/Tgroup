...
export function ToothPickerModal({ isOpen, initialValues = [], onClose, onSave }: ToothPickerModalProps) {
  ...
  const renderQuadrant = (nums: number[], reverse = false) => (
    <div className="overflow-x-auto w-full">
      <div className="flex gap-1 justify-center items-center min-w-max">
        {nums.map((n) => {
          ...
          return (
            <button
              ...
              className={[
                'w-10 flex cursor-pointer select-none border p-0.5 transition-colors',
                'items-center',
            ...
            >
              <div className="w-9 h-[48px] flex items-center justify-center pointer-events-none">
                <img
              ...
              <div
                className={[
                  'w-full text-center text-[11px] py-0.5 font-variant-numeric tabular-nums leading-none',
