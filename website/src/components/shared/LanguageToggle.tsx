  ...
  return (
    <div ref={ref} className="relative w-full">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-white/10 transition-colors w-full"
      ...
      {open && (
        <div data-testid="lang-dropdown" className="absolute bottom-full mb-1 left-0 right-0 bg-white rounded-xl shadow-2xl border border-gray-200 py-1 z-[200] min-w-[160px]">
