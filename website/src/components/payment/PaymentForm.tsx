            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">
                  {isEdit ? 'Chỉnh sửa thanh toán' : 'Ghi nhận thanh toán'}
                </h2>
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-1 text-xs text-blue-500">
                  ...
                  Kết hợp nhiều nguồn — tối đa {formatVND(cap)}
                </span>
              </div>
              ...
              {remaining > 0 ? (
                <span key="remaining" className="text-xs text-gray-500 animate-in fade-in duration-200">
                  Còn lại: <span className="font-semibold text-gray-700 tabular-nums">{formatVND(remaining)}</span>
                </span>
              ) : (
                <span key="full" className="text-xs font-semibold text-emerald-600 animate-in fade-in duration-200">Đã đủ</span>
              )}
            </div>
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-gray-500 ml-2">Sẵn: {formatVND(availableDeposit)}</span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    title={cap <= 0 ? 'Số dư tối đa đã đạt' : undefined}
            ...
            >
              ...
              {atCap && (
                <div className="flex items-center gap-1 mt-2 text-xs text-emerald-600 animate-in fade-in slide-in-from-bottom-1 duration-300">
                  ...
                  Đã đạt giới hạn còn nợ của dịch vụ
                </div>
              )}
            </div>
          </div>
