...
/**
 * @crossref:domain[ctv]
 * @crossref:used-in[api/src/services/exports/exportRegistry.js ('ctv-earnings' type → api/src/routes/exports.js)]
 * @crossref:uses[api/src/db.js (getDb dual-LOB), api/src/services/exports/exportWorkbook.js, api/src/routes/earnings.js (mirrored query), product-map/domains/ctv.yaml]
 */
/**
