-- Migration 050: restore payment deposit classification and destructive payment permissions.
-- This deploy-applied migration is idempotent and safe to re-run.
