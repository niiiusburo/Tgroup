 ...
 * @crossref:used-in[POST /api/Reports/revenue/by-doctor|by-category|by-source|payment-plans: mounted via api/src/routes/reports.js; called by website/src/hooks/useReportData.ts]
 * @crossref:uses[api/src/db.js, api/src/middleware/auth.js, api/src/routes/reports/helpers.js, api/src/routes/reports/revenueRecognition.js (canonical revenue SQL/filters), product-map/domains/reports-analytics.yaml]
 */
