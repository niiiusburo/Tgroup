...
router.post("/", requirePermission(['payment.edit', 'payment.add']), validate(PaymentCreateSchema), async (req, res) => {
  let client;
  try {
    let {
...
router.post("/refund", requirePermission(['payment.edit', 'payment.refund']), async (req, res) => {
  try {
...
router.patch("/:id", requirePermission(['payment.edit', 'payment.update']), validate(PaymentUpdateSchema), async (req, res) => {
  try {
    const { id } = req.params;
...
router.delete("/:id", requirePermission(['payment.edit', 'payment.void']), async (req, res) => {
  const { id } = req.params;
...
router.post("/:id/void", requirePermission(['payment.edit', 'payment.void']), async (req, res) => {
  const { id } = req.params;
...
router.post("/:id/proof", requirePermission(['payment.edit', 'payment.add']), async (req, res) => {
  try {
    const { id } = req.params;
