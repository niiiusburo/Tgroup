...
-- @crossref:used-in[NK3 schema migration: api/migrations/067_chat_support_ai]
-- @crossref:uses[product-map/domains/patient-portal.yaml, docs/MIGRATIONS.md, docs/TEST-MATRIX.md, testbright.md]
/**
