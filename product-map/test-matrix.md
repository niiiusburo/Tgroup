...
| `src/services/__tests__/comprefaceFaceProvider.test.js` | Integrations / Investor | CompreFace provider mapping, allowlisted subject hydration/ranking, empty-scope failure, registration status, and `NO_FACE` normalization |
