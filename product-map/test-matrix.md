...
| `src/services/reports/__tests__/canonicalRevenue.test.js` | Reports/Exports | UC-013/WF-013/INV-021: canonical revenue SQL mirrors the Excel `revenue-flat` export WHERE/JOIN topology, allocation capping expression, saleorder attribution, payment-date bucketing, and investor empty-allowlist fail-closed |
